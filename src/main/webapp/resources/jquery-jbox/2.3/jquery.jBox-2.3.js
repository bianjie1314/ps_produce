...
(function (a) {
	a.jBox = function (b, c) {
		...
		a.each(b, function (N, O) {
			...
			r.push('<div style="min-width:50px;width:' + (typeof c.width == 'number' ? c.width + 'px' : 'auto') + '; height:' + Q + ';">' + R + '<div id="jbox-content" class="jbox-content" style="height:' + Q + ';overflow:hidden;overflow-y:visible;">' + O.content + '</div></div>');
